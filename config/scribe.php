...
return [
    ...
    'title' => 'Klinic 360 API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Multi-tenant clinic management API for Ayurveda, Siddha & Homeopathy practices. Authenticate with a Bearer token obtained from `POST /api/v1/auth/login`. All endpoints are tenant-scoped via the token.',
