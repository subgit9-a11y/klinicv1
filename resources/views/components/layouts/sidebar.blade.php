@php
    $nav = [
        ...
        ['route' => 'followups.index', 'label' => 'Follow-ups', 'icon' => '↻'],
        ['route' => 'investigations.index', 'label' => 'Labs', 'icon' => '🧪'],
        ...
        ['route' => 'settings.clinic', 'label' => 'Clinic setup', 'icon' => 'C'],
        ['route' => 'notification-templates.index', 'label' => 'Templates', 'icon' => 'T'],
    ];
    $adminNav = [
        ...
        ['route' => 'super-admin.ai-prompts', 'label' => 'AI Prompts', 'icon' => '🧠'],
